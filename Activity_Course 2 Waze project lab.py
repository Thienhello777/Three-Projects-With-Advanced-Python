...
# 1. We have 0 values but do not have any NAN values here.
# 2. We have seven variables type int64, 2 varibles type object, 3 varibles type float64. 12 columns and 1499 rows.
# 3. We have 700 null values. Label field has null values.
...
### YOUR CODE HERE ###
nonnull_data = df[df.notnull().any(axis=1)]
# Display summary stats of rows without null values
### YOUR CODE HERE ###
nonnull_data.describe()
...
### YOUR CODE HERE ###
null_data['device'].value_counts()


# ==> 447 users iPhone have more null values than Android one.
...
### YOUR CODE HERE ###
null_data['device'].value_counts(normalize=True) 


# How does this compare to the device ratio in the full dataset?
# The iPhone device users in null dataset have 63.85% < iPhone device users in full dataset and vice versa
...
### YOUR CODE HERE ###
df.groupby('label').agg(np.median)
...
### YOUR CODE HERE ###
df['drive_per_driving_day'] = df['drives'] / df['driving_days']
# Group by `label`, calculate the median, and isolate for drives per driving day
### YOUR CODE HERE ###
df.groupby('label')['drive_per_driving_day'].median()
